      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button 
            ...
            className="w-full sm:w-auto px-10 py-5 bg-white text-black font-black rounded-2xl transition-all shadow-2xl shadow-white/10 text-xl hover:scale-105 active:scale-95"
          >
            Explorar Achadinhos
          </button>
          <button 
            onClick={scrollToHowItWorks}
            className="w-full sm:w-auto px-10 py-5 bg-zinc-900/50 border border-zinc-800 hover:bg-zinc-800 text-zinc-100 font-bold rounded-2xl transition-all text-xl backdrop-blur-md"
          >
            Como funciona?
          </button>
        </div>
